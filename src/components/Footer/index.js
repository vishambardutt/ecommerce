  ...
  return (
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Vishambar Dutt —
            <a href="https://twitter.com/vishambar1" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">Ecom with Tailwind Css</a>
          </p>
